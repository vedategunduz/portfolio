...
<div class="relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto text-center" x-data="{ loaded: true }">
        <h1 class="text-5xl md:text-7xl font-bold text-[#1b1b18] dark:text-[#EDEDEC] mb-6 transition-all duration-500 opacity-100 translate-y-0"
            >
            Merhaba, ben
            <span class="text-[#D62113]">Vedat</span>
        </h1>
        <p class="text-xl md:text-2xl text-[#706f6c] dark:text-[#D4D3D0] max-w-3xl mx-auto mb-8 transition-all duration-500 delay-100 opacity-100 translate-y-0"
           >
        ...
        <div class="flex gap-4 justify-center flex-wrap transition-all duration-500 delay-200 opacity-100 translate-y-0">
