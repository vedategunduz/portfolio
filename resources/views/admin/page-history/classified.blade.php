...
@section('title', __('messages.page_history.classified') . __('messages.admin.title_suffix') . config('app.name'))
...
@section('content')
    <x-admin.ui.filter-card title="{{ __('messages.filters') }}" :action="route('admin.page-history.classified')" method="get">
        ...
        <div class="flex flex-wrap items-end gap-2 sm:col-span-2 lg:col-span-4">
            ...
            <x-admin.ui.button variant="secondary" :href="route('admin.page-history.classified')">
